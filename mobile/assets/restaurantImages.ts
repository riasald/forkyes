...
const images: Record<string, any> = {
  ...
  "sushi-2-go":require("./images/Suhsi-2-Go.jpg"),
  "sus-hi-eatstation":require("./images/Sus-Hi Eatstation.jpg"),
  "hurricane-btw-burgers-tacos-wings": require("./images/Hurricane.jpg"),
